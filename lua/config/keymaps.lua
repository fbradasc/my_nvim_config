...
vim.keymap.set(
    'n',
    '<F3>'      ,
    ':Neotree toggle source=git_status float<CR>',
    {
        unique = true,
        silent = true,
...
vim.keymap.set(
    'n',
    '<F4>'      ,
    ':Neotree toggle source=document_symbols position=right<CR>',
    {
        unique = true,
        silent = true,
...
vim.keymap.set(
    'n',
    '<F5>'      ,
    ':Neotree toggle source=buffers position=left<CR>',
    {
        unique = true,
        silent = true,
...
vim.keymap.set(
    'n',
    '<F6>'      ,
    ':Neotree toggle source=diagnostics position=bottom<CR>',
    {
        unique = true,
        silent = true,
        desc = 'Toggle buffers explorer' 
...
vim.keymap.set(
    'n',
    '<leader>gg',
    ':grep \'<cword>\'<CR>:botright copen<CR>',
    {
        silent = true,
...
vim.keymap.set(
    'n',
    '<leader>gs',
    ':grep \'<C-r>/\'<CR>:botright copen<CR>',
    {
        silent = true,
        desc = 'Grep last search pattern' 
    }
)
